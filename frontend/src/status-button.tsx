...
const StatusButton: React.FC<StatusButtonProps> = ({ status, onClick } ) => {
  ...
  const theme = mantineTheme.colorScheme === 'dark' ? queryColors.dark : queryColors.light;
  ...
  return (
    <button
      ...
      style={{
        background: isHovered ? lighten(colorSet.background, 0.1) : colorSet.background,
